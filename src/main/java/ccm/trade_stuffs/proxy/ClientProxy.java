...
public class ClientProxy extends CommonProxy
{
                                      ...
                                      final int z)
    {
        ...
        {
            case Guis.GUI_TRADE:
                return new GuiTrade(player.inventory, (TileEntityTradeStation) world.getBlockTileEntity(x,
                                                                                                        y,
                                                                                                        z));
            case Guis.GUI_BANK:
            ...
            case Guis.GUI_SAFE:
                return new GuiSafePassLock(player.inventory, (TileEntitySafe) world.getBlockTileEntity(x,
                                                                                                       y,
                                                                                                       z));
