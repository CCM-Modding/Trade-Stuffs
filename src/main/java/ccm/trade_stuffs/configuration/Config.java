...
public final class Config
{
    ...
    public static void load(final FMLPreInitializationEvent event)
    {
        ...
        cat = "CoinDrops";
        config.addCustomCategoryComment(cat, "Coin Type,Drop Chance, Min/Max Drops are all editable here per mob. " +
        		"Coin Type (Type of coin)" +
        		"	0 = Copper (Value of 1)" +
        ...
        config.addCustomCategoryComment(cat, "Villager");
        Properties.COIN_TYPE_VILLAGER = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_VILLAGER_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Horse");
        Properties.COIN_TYPE_HORSE = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_HORSE_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Ocelot");
        Properties.COIN_TYPE_OCELOT = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_OCELOT_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Mooshrrom");
        Properties.COIN_TYPE_MOOSHROOM = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_MOOSHROOM_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Wolf");
        Properties.COIN_TYPE_WOLF = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_WOLF_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Squid");
        Properties.COIN_TYPE_SQUID = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_SQUID_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Chicken");
        Properties.COIN_TYPE_CHICKEN = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_CHICKEN_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Cow");
        Properties.COIN_TYPE_COW = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_COW_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Sheep");
        Properties.COIN_TYPE_SHEEP = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_SHEEP_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Bat");
        Properties.COIN_TYPE_BAT = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_BAT_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.10).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Pig");
        Properties.COIN_TYPE_PIG = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_PIG_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Witch");
        Properties.COIN_TYPE_WITCH = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_WITCH_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.25).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "MagmaCube");
        Properties.COIN_TYPE_MAGMACUBE = config.get(cat, "Coin_Type", 1).getInt();
        Properties.COIN_MAGMACUBE_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.80).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Blaze");
        Properties.COIN_TYPE_BLAZE = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_BLAZE_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.65).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "SilverFish");
        Properties.COIN_TYPE_SILVERFISH = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_SILVERFISH_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "CaveSpider");
        Properties.COIN_TYPE_CAVESPIDER = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_CAVESPIDER_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.15).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Endermen");
        Properties.COIN_TYPE_ENDERMEN = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_ENDERMEN_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.60).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "PigZombie");
        Properties.COIN_TYPE_PIGZOMBIE = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_PIGZOMBIE_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.25).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Ghast");
        Properties.COIN_TYPE_GHAST = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_GHAST_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.30).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Slime");
        Properties.COIN_TYPE_SLIME = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_SLIME_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.05).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Zombie");
        Properties.COIN_TYPE_ZOMBIE = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_ZOMBIE_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.25).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "GiantZombie");
        Properties.COIN_TYPE_GIANTZOMBIE = config.get(cat, "Coin_Type", 1).getInt();
        Properties.COIN_GIANTZOMBIE_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.70).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Spider");
        Properties.COIN_TYPE_SPIDER = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_SPIDER_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.25).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Skeleton");
        Properties.COIN_TYPE_SKELETON = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_SKELETON_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.30).getDouble(1);
        ...
        config.addCustomCategoryComment(cat, "Creeper");
        Properties.COIN_TYPE_CREEPER = config.get(cat, "Coin_Type", 0).getInt();
        Properties.COIN_CREEPER_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.40).getDouble(1);
        ...
        Properties.COIN_DRAGON_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.75).getDouble(1);
        ...
        Properties.COIN_WITHER_DROP_CHANCE = config.get(cat, "Coin_Drop_Chance", 0.75).getDouble(1);
        ...
        Properties.WALLET_WITHER_DROP_CHANCE = config.get(cat, "Bag_Drop_Chance", 0.50).getDouble(1);
